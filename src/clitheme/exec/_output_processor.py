...
def _match_content(content: bytes, command: Optional[str]=None, is_stderr: bool=False, pids: Tuple[int,int]=(-1,-1)) -> Tuple[bytes, Set[int]]:
    ...
    # -> Check if affected *lines* in the condition map is marked
